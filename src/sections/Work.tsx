  ...
  return (
    <section id="work" className="relative bg-cream text-ink">
      ...
      <a
        ...
        className="group flex items-center justify-between gap-6 border-y border-ink/15 px-frame h-[110px] min-[900px]:h-[150px] hover:bg-ink hover:text-cream transition-colors duration-500"
      >
      ...
      {/* stacked project cards — centred composition */}
          ...
          <article key={p.n} className="stack-card bg-ink-3 text-cream grain">
            ...
            <div className="absolute z-[4] top-0 inset-x-0 px-frame pt-6 flex items-start justify-between">
              ...
              <span className="text-right">
                <span className="block f-mono"><span className="text-cream/45">Client&nbsp;&nbsp;</span><b>{p.client}</b></span>
